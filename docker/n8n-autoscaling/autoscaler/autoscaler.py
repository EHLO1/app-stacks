...
N8N_WORKER_RUNNER_SERVICE_NAME = os.getenv('N8N_WORKER_RUNNER_SERVICE_NAME', 'n8n-worker-runner')
COMPOSE_PROJECT_NAME = os.getenv('COMPOSE_PROJECT_NAME')
COMPOSE_FILE_PATH = os.getenv('COMPOSE_FILE_PATH') # Path inside n8n-autoscaler container
...
def scale_worker_with_runner(replicas, compose_file, project_name):
    """Scales both the n8n worker and its task runner sidecar together."""
